...
name:"Less",case_insensitive:!0,illegal:"[=>'/<($\"]",contains:c}}})());hljs.registerLanguage("scss",(()=>{"use strict"
...
end:/[^\\](?=\s*$)/,subLanguage:"bash"}}]})})());hljs.registerLanguage("python-repl",(()=>{"use strict";return s=>({
...
},...B,..._,...M,I,P,...z,...q,U,V]}}})());hljs.registerLanguage("vim",(()=>{"use strict";return e=>({name:"Vim Script",
keywords:{$pattern:/[!#@\w]+/,
...
strings:i,keywords:u}}}})());hljs.registerLanguage("django",(()=>{"use strict";return e=>{const t={
...
aliases:["yml"],contains:b}}})());hljs.registerLanguage("plaintext",(()=>{"use strict";return t=>({
